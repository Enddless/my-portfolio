...
export const projectsData = [
  {
    id: 0,
    name: 'Just le studia',
    text: 'Сайт-шаблон для небольшой студии (b2b). Администратором возможно добавление / редактирование / удаление контента сайта: логотипа, информации о залах, преподавателях, расписании, абонементах, юридических документов, контактов, координат для интерактивной карты. Пользователю предлагается просмотреть всю информацию о студии на предложенных страницах,а так же зарегистрироваться в личном кабинете и произвести запись. /Деплой в процессе/',
    deploy: '',
    github: '',
    stack:
  ...
  },
  {
    id: 1,
    name: 'На кухне',
    text: ' Сайт - сборник рецептов, который поможет вкусно и разнообразно питаться, учитывает индивидуальные предпочтения пользователя, указанные в профиле. Пользователь может добавить в список покупок ингредиенты из любого выбранного рецепта, а так же, пользуясь удобным калькулятором, может отрегулировать нужное количество порций.',
  ...
  },
  {
    id: 2,
    name: 'Dream house',
    text: 'Сайт фирмы, специализирующейся на создании уникальных дизайнов для загородных домов, которые отражают стиль, предпочтения и потребности. Пользователю предлагается просмотреть уникальные дизайны трех предложенных вариантов',
  ...
  },
  {
    id: 3,
    name: 'Tourist',
    text: 'Блог туриста, раскрывающий все тонкости путешествий. Фотографии эффектно и неназойливо появляются с разных сторон, в зависимости от скролла. Пользователь виртуально окунается в фотографии путешественника.',
